            ...
            for customer in customers:
                ...
                try:
                    send_mail(
                        ...
                        f'Hello {customer.name},\n\nYou have been referred to a new campaign: {campaign.title}.\nYour referral code is: {campaign_customer.referral_code}. Use this link to refer new individuals and claim your reward - http://127.0.0.1:8000/refer_customer/{campaign_customer.referral_code}\n\nBest regards,\n{business_owner.business_name}',
            ...
            try:
                ...
                try:
                    send_mail(
                        ...
                        f'Hello {form.cleaned_data["name"]},\n\nYou have been referred to join our campaign: {campaign_customer.campaign.title}.Please use the referral code to get onboarded {campaign_customer.referral_code}. You can use this link to compelte the onboarding process. http://127.0.0.1:8000/onboard/ \n\nBest regards,\n{campaign_customer.customer.owner.business_name}',
